...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_4.setGeometry(QtCore.QRect(580, 10, 471, 511))
        ...
        self.agent2_frame.setGeometry(QtCore.QRect(10, 360, 451, 141))
        ...
        self.agent1_frame.setGeometry(QtCore.QRect(10, 210, 451, 141))
        ...
        self.frame_2.setGeometry(QtCore.QRect(20, 530, 1031, 101))
        ...
        self.frame_6.setGeometry(QtCore.QRect(1060, 10, 421, 511))
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_6.setObjectName("frame_6")
        self.frame_11 = QtWidgets.QFrame(self.frame_6)
        self.frame_11.setGeometry(QtCore.QRect(10, 370, 401, 121))
        ...
        self.robot2_likelihood_label.setGeometry(QtCore.QRect(10, 30, 271, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.robot2_likelihood_label.setFont(font)
        self.robot2_likelihood_label.setObjectName("robot2_likelihood_label")
        self.robot2_delivery_assessment_value = QtWidgets.QLabel(self.frame_11)
        self.robot2_delivery_assessment_value.setGeometry(QtCore.QRect(280, 30, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.robot2_delivery_assessment_value.setFont(font)
        self.robot2_delivery_assessment_value.setTextFormat(QtCore.Qt.AutoText)
        self.robot2_delivery_assessment_value.setScaledContents(False)
        self.robot2_delivery_assessment_value.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.robot2_delivery_assessment_value.setObjectName("robot2_delivery_assessment_value")
        ...
        self.frame_15.setGeometry(QtCore.QRect(10, 120, 401, 91))
        self.frame_15.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_15.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_15.setObjectName("frame_15")
        self.operator_alert_slider = QtWidgets.QSlider(self.frame_15)
        self.operator_alert_slider.setGeometry(QtCore.QRect(10, 60, 381, 22))
        ...
        self.operator_alert_description.setGeometry(QtCore.QRect(0, 0, 401, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.task_assessment_label.setGeometry(QtCore.QRect(10, 10, 401, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setUnderline(True)
        ...
        self.frame_10.setGeometry(QtCore.QRect(10, 220, 401, 121))
        ...
        self.robot1_likelihood_label.setGeometry(QtCore.QRect(10, 30, 271, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.robot1_likelihood_label.setFont(font)
        self.robot1_likelihood_label.setObjectName("robot1_likelihood_label")
        self.robot1_delivery_assessment_value = QtWidgets.QLabel(self.frame_10)
        self.robot1_delivery_assessment_value.setGeometry(QtCore.QRect(280, 30, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.robot1_delivery_assessment_value.setFont(font)
        self.robot1_delivery_assessment_value.setTextFormat(QtCore.Qt.AutoText)
        self.robot1_delivery_assessment_value.setScaledContents(False)
        self.robot1_delivery_assessment_value.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.robot1_delivery_assessment_value.setObjectName("robot1_delivery_assessment_value")
        ...
        self.assessment_button.setGeometry(QtCore.QRect(110, 60, 201, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.robot2_delivery_assessment_value.setText(_translate("MainWindow", "-"))
        ...
        self.operator_alert_description.setText(_translate("MainWindow", "Alert the operator when confidence is below:"))
        ...
        self.robot1_delivery_assessment_value.setText(_translate("MainWindow", "-"))
